...
(function () {
  ...
  var AIRPORTS = [
    ...
    ["LGW","London Gatwick","london-gatwick"], ["LPL","Liverpool","liverpool"], ["BFS","Belfast","belfast"], ["BOH","Bournemouth","bournemouth"], ["CWL","Cardiff","cardiff"], ["EMA","East Midlands","east-midlands"], ["DUB","Dublin","dublin"], ["EXT","Exeter","exeter"], ["LHR","London Heathrow","london-heathrow"], ["SEN","London Southend","london-southend"], ["LCY","London City","london-city"], ["PIK","Glasgow Prestwick","prestwick"], ["BHD","Belfast City","belfast-city"], ["ORK","Cork","cork"], ["SNN","Shannon","shannon"], ["SOU","Southampton","southampton"], ["ABZ","Aberdeen","aberdeen"], ["NWI","Norwich","norwich"], ["NQY","Newquay","newquay"], ["NOC","Knock","knock"], ["MME","Teesside","teesside"], ["INV","Inverness","inverness"], ["HUY","Humberside","humberside"], ["JER","Jersey","jersey"], ["GCI","Guernsey","guernsey"], ["IOM","Isle of Man","isle-of-man"], ["KIR","Kerry","kerry"], ["LDY","City of Derry","derry"], ["DND","Dundee","dundee"]
  ];
  ...
  function isles(dest) { return !!UK[dest] || !!IE[dest] || !!CD[dest]; }
  ...
  function signedOut() {
    root.innerHTML =
      '<div class="chm-card chm-gate">' +
        ...
        '<a class="chm-btn" href="/sign-in/">Sign in</a> <a class="chm-btn chm-ghost" href="/choose-city/">Join for £2.99</a>' +
      '</div>';
  }
    ...
    root.innerHTML =
      '<div class="chm-hero">' +
        ...
        '<p>' + (ap ? "Your airport is <b>" + esc(ap[1]) + "</b>. " : "Tell us your airport and everything on this page follows it. ") +
          (ms.paid ? "Every email we send you is kept here." : 'Members get the full list every Monday and go straight through to book any fare. <a href="#/portal/account/plans"><b>Join for £2.99 &rarr;</b></a>') + '</p></div>' +
