...
(function () {
  ...
  var AIRPORTS = [
    ...
    ["LGW","London Gatwick","london-gatwick"], ["LPL","Liverpool","liverpool"], ["BFS","Belfast","belfast"], ["BOH","Bournemouth","bournemouth"], ["CWL","Cardiff","cardiff"], ["EMA","East Midlands","east-midlands"], ["DUB","Dublin","dublin"], ["EXT","Exeter","exeter"], ["PIK","Glasgow Prestwick","prestwick"], ["ORK","Cork","cork"], ["SNN","Shannon","shannon"], ["ABZ","Aberdeen","aberdeen"], ["NWI","Norwich","norwich"], ["NQY","Newquay","newquay"], ["NOC","Knock","knock"], ["MME","Teesside","teesside"], ["KIR","Kerry","kerry"]
  ];
