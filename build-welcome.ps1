...
$AIRPORT_NAME = @{ MAN="Manchester"; BHX="Birmingham"; LBA="Leeds Bradford"; STN="London Stansted"; LTN="London Luton";
  ...
  BFS="Belfast"; BOH="Bournemouth"; CWL="Cardiff"; EMA="East Midlands"; DUB="Dublin"; EXT="Exeter"; LHR="London Heathrow"; SEN="London Southend"; LCY="London City"; PIK="Glasgow Prestwick"; BHD="Belfast City"; ORK="Cork"; SNN="Shannon"; SOU="Southampton"; ABZ="Aberdeen"; NWI="Norwich"; NQY="Newquay"; NOC="Knock"; MME="Teesside"; INV="Inverness" }
...
# reads as 31 airports rather than one.
$pool = @()
...
$head = "<table width=`"100%`" cellpadding=`"0`" cellspacing=`"0`" border=`"0`" bgcolor=`"#0E6FB6`" style=`"background:#0E6FB6;border-radius:18px;`"><tr><td style=`"padding:26px 22px 22px;text-align:center;$FONT`">" +
  ...
  "<div style=`"font-size:14.5px;color:#D7EDFA;line-height:1.5;max-width:34em;margin:0 auto;`">Thanks for joining. Here is what we found this morning across all 31 airports, so you can see what lands in your inbox every Monday.</div>" +
  "</td></tr></table>"
...
$post = @{ posts = @(@{
  ...
  status = "draft"
  visibility = "members"
  custom_excerpt = "The best fares from all 31 airports today, and what lands in your inbox on Monday."
