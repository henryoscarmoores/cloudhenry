...
$AIRPORT_NAME = @{ MAN="Manchester"; BHX="Birmingham"; LBA="Leeds Bradford"; STN="London Stansted"; LTN="London Luton";
  ...
  BFS="Belfast"; BOH="Bournemouth"; CWL="Cardiff"; EMA="East Midlands"; DUB="Dublin"; EXT="Exeter"; LHR="London Heathrow"; SEN="London Southend"; LCY="London City"; PIK="Glasgow Prestwick"; BHD="Belfast City"; ORK="Cork"; SNN="Shannon"; SOU="Southampton"; ABZ="Aberdeen"; NWI="Norwich"; NQY="Newquay"; NOC="Knock"; MME="Teesside"; INV="Inverness"; HUY="Humberside"; JER="Jersey"; GCI="Guernsey"; IOM="Isle of Man"; KIR="Kerry"; LDY="City of Derry"; DND="Dundee" }
...
# reads as 38 airports rather than one.
$pool = @()
...
$post = @{ posts = @(@{
  ...
  status = "draft"
  visibility = "members"
  custom_excerpt = "The best fares from all 38 airports today, and what lands in your inbox on Monday."
