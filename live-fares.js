...
(function () {
  ...
  function paintLockCard() {
    ...
    if (t) t.textContent = fromCity ? "Every fare from " + fromCity + ", every date" : "Every fare, every date, all 26 airports";
    ...
    if (fine) fine.innerHTML = memberPaid
      ...
      : '<span class="ch-hlb">£2.99 a month</span> · or £29 a year · cancel anytime';
  }
