 ...
 *      back to this page.
 *   2. Back here, signed in: join the paid tier
...
(function () {
  ...
  var NAMES = {
    ...
    "glasgow":"Glasgow", "edinburgh":"Edinburgh", "london-gatwick":"London Gatwick", "liverpool":"Liverpool", "belfast":"Belfast", "bournemouth":"Bournemouth", "cardiff":"Cardiff", "east-midlands":"East Midlands", "dublin":"Dublin", "exeter":"Exeter", "london-heathrow":"London Heathrow", "london-southend":"London Southend", "london-city":"London City", "prestwick":"Glasgow Prestwick", "belfast-city":"Belfast City", "cork":"Cork", "shannon":"Shannon", "southampton":"Southampton", "aberdeen":"Aberdeen", "norwich":"Norwich", "newquay":"Newquay", "knock":"Knock", "teesside":"Teesside", "inverness":"Inverness", "humberside":"Humberside", "jersey":"Jersey", "guernsey":"Guernsey", "isle-of-man":"Isle of Man", "kerry":"Kerry", "derry":"City of Derry", "dundee":"Dundee"
  };
  var CODES = { "manchester":"MAN", "birmingham":"BHX", "leeds":"LBA", "leeds-bradford":"LBA", "london-stansted":"STN",
                ...
                "london-gatwick":"LGW", "liverpool":"LPL", "belfast":"BFS", "bournemouth":"BOH", "cardiff":"CWL", "east-midlands":"EMA", "dublin":"DUB", "exeter":"EXT", "london-heathrow":"LHR", "london-southend":"SEN", "london-city":"LCY", "prestwick":"PIK", "belfast-city":"BHD", "cork":"ORK", "shannon":"SNN", "southampton":"SOU", "aberdeen":"ABZ", "norwich":"NWI", "newquay":"NQY", "knock":"NOC", "teesside":"MME", "inverness":"INV", "humberside":"HUY", "jersey":"JER", "guernsey":"GCI", "isle-of-man":"IOM", "kerry":"KIR", "derry":"LDY", "dundee":"DND" };
  var city = NAMES[slug];
  if (!city) return;
  ...
  function build(cta, mm) {
    ...
    if (mm && isPaid(mm)) {
      ...
      box.innerHTML = '<a class="ch-join-cta" href="#/portal/account/plans">Join for £2.99 &rarr;</a>' +
                      '<div class="ch-join-note">£2.99 a month or £29 a year, cancel any time. Your ' + city + ' email starts on Monday.</div>' +
                      '<small>Signed in as ' + escapeHtml(mm.email) + '</small>';
      ...
      box.innerHTML =
        ...
        '</form>' +
        '<div class="ch-join-note">You are on the list the moment you press. We also email you a link to join for £2.99 a month.</div>' +
