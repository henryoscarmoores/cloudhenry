...
(function () {
  ...
  var CSS = [
    '.chfg{font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;max-width:400px;width:calc(100% - 44px);margin:52px auto 60px;padding:22px 20px 24px;text-align:center;color:#fff;background:rgba(255,255,255,.13);border:1px solid rgba(255,255,255,.22);border-radius:20px;box-shadow:0 10px 30px rgba(6,52,90,.16)}',
    ...
    '.chfg-q{font-size:17.5px;font-weight:750;line-height:1.3;margin:0 0 5px;text-shadow:0 1px 5px rgba(6,52,90,.4)}',
    '.chfg-s{font-size:12px;font-weight:600;letter-spacing:.02em;color:rgba(255,255,255,.72);margin:0 0 16px;font-variant-numeric:tabular-nums}',
    '.chfg-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}',
    '.chfg-btn{border:2px solid rgba(255,255,255,.5);border-radius:11px;background:rgba(255,255,255,.14);padding:6px;cursor:pointer;display:block;transition:transform .16s cubic-bezier(.22,.61,.36,1),border-color .16s,box-shadow .16s;box-shadow:0 2px 7px rgba(6,52,90,.18)}',
